...
/**
 * Initialisiert das Level-Grid mit Standardwerten.
 * 
 * @param level Zeiger auf das Level-Objekt, das initialisiert werden soll.
 */
void initLevelGrid(Level *level);

/**
 * Verarbeitet Mausklicks und ändert den Typ der angeklickten Zelle.
 * 
 * @param button SDL_MouseButtonEvent, enthält Informationen über den Mausklick.
 * @param level Zeiger auf das Level-Objekt, in dem die Änderungen vorgenommen werden.
 */
void handleMouseClick(SDL_MouseButtonEvent button, Level *level);

/**
 * Zeichnet das Level-Grid im Fenster.
 * 
 * @param renderer Zeiger auf den SDL_Renderer, der für das Zeichnen verwendet wird.
 * @param level Zeiger auf das Level-Objekt, das gezeichnet werden soll.
 */
void renderGrid(SDL_Renderer *renderer, const Level *level);

/**
 * Speichert das bearbeitete Level in einer Datei.
 * 
 * @param level Zeiger auf das Level-Objekt, das gespeichert werden soll.
