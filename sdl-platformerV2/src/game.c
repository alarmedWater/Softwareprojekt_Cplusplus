...
/*pi@raspberrypi:~/Dokumente/SoftwareProjekt/Softwareprojekt_Cplusplus/sdl-platformerV2/src $ make
cc  -c game.c -o game.o
cc  -c gpio_control.c -o gpio_control.o
cc  -c helpers.c -o helpers.o
cc  -c levels.c -o levels.o
cc    -c -o main.o main.c
cc  -c objects.c -o objects.o
cc  -c render.c -o render.o
cc  -c types.c -o types.o
cc  framecontrol.o game.o gpio_control.o helpers.o levels.o main.o objects.o render.o types.o -I/usr/include/SDL2 -lSDL2 -lSDL2_ttf -lm -o sdl_platformer
/usr/bin/ld: gpio_control.o: in function `initializeGPIO':
gpio_control.c:(.text+0x8): undefined reference to `wiringPiSetup'
/usr/bin/ld: gpio_control.c:(.text+0x30): undefined reference to `pinMode'
/usr/bin/ld: gpio_control.c:(.text+0x3c): undefined reference to `pullUpDnControl'
/usr/bin/ld: gpio_control.c:(.text+0x48): undefined reference to `pinMode'
/usr/bin/ld: gpio_control.c:(.text+0x54): undefined reference to `pullUpDnControl'
/usr/bin/ld: gpio_control.c:(.text+0x60): undefined reference to `pinMode'
/usr/bin/ld: gpio_control.c:(.text+0x6c): undefined reference to `pullUpDnControl'
/usr/bin/ld: gpio_control.c:(.text+0x78): undefined reference to `pinMode'
/usr/bin/ld: gpio_control.c:(.text+0x84): undefined reference to `pullUpDnControl'
/usr/bin/ld: gpio_control.c:(.text+0x90): undefined reference to `pinMode'
/usr/bin/ld: gpio_control.c:(.text+0x9c): undefined reference to `pullUpDnControl'
/usr/bin/ld: gpio_control.o: in function `readLeftButton':
gpio_control.c:(.text+0xb8): undefined reference to `digitalRead'
/usr/bin/ld: gpio_control.o: in function `readRightButton':
gpio_control.c:(.text+0xe4): undefined reference to `digitalRead'
/usr/bin/ld: gpio_control.o: in function `readUpButton':
gpio_control.c:(.text+0x110): undefined reference to `digitalRead'
/usr/bin/ld: gpio_control.o: in function `readDownButton':
gpio_control.c:(.text+0x13c): undefined reference to `digitalRead'
/usr/bin/ld: gpio_control.o: in function `readSpaceButton':
gpio_control.c:(.text+0x168): undefined reference to `digitalRead'
collect2: error: ld returned 1 exit status
make: *** [Makefile:36: sdl_platformer] Fehler 1
*/